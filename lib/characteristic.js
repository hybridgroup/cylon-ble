...
var BLECharacteristic = module.exports = function BLECharacteristic(opts) {
  ...
  this.commands = {
    getCharacteristic: this.getCharacteristic,
...
/**
 * Gets the current value of characteristic of the BLE device
 *
 * @param {Function} callback to be triggered when characteristic data is read
 * @return {void}
 * @publish
 */
BLECharacteristic.prototype.getCharacteristic = function(callback) {
...
/**
 * Sets the current value of characteristic of the BLE device
 *
 * @param {Number} value value to write
 * @param {Function} callback function to call when done
 * @return {void}
 */
BLECharacteristic.prototype.setCharacteristic = function(value, callback) {
