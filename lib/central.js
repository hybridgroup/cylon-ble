...
Central.prototype.setServiceCharacteristic = function(serviceId, characteristicId, value, cb) {
  if (!this.isConnected) {cb("Not connected", null); return;}
...
Central.prototype.setServiceCharacteristicNotify = function(serviceId, characteristicId, state, cb) {
  if (!this.isConnected) {cb("Not connected", null); return;}
