...
Central.prototype.commands = ['startScanning', 'stopScanning', 'peripherals', 'getServiceCharacteristic', 'getServiceCharacteristicNotify'];
...
Central.prototype.getServiceCharacteristicNotify = function(serviceId, characteristicId, state, callback) {
  this.getCharacteristic(serviceId, characteristicId, function(err, c) {
