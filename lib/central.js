...
var alreadyDiscoveredCharacteristics = {};
...
Central.prototype.getCharacteristic = function(serviceId, characteristicId, callback) {
  ...
  if (alreadyDiscoveredCharacteristics[serviceId] && alreadyDiscoveredCharacteristics[serviceId][characteristicId]) {
    return callback(null, alreadyDiscoveredCharacteristics[serviceId][characteristicId]);
  }
  ...
  p.connect(function() {
    p.discoverServices([serviceId], function(serErr, services) {
      ...
      if (services.length > 0) {
        var s = services[0];
        alreadyDiscoveredCharacteristics[s.uuid] = {uuid: s.uuid};
        ...
        s.discoverCharacteristics([characteristicId], function(charErr, characteristics) {
          ...
          alreadyDiscoveredCharacteristics[s.uuid][c.uuid] = c;
          callback(null, c);
        });
      } else {
